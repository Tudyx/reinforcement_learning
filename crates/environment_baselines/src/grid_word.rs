...
use rl_environemnt::environment::RenderMode;
use rl_environemnt::Environment;
...
impl Environment for GridWorldEnv {
    ...
    fn metadata() -> rl_environment::environment::Metadata {
        rl_environment::environment::Metadata {
